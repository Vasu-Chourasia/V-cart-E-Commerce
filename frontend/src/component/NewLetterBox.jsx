    ...
    return (
        <section className='w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
            <div className='w-full bg-gradient-to-r from-[#12282e]/90 via-[#19353c]/90 to-[#12282e]/90 backdrop-blur-md border border-[#56dbfc]/20 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col items-center text-center gap-4 relative overflow-hidden'>
                ...
                <form onSubmit={(e) => e.preventDefault()} className='flex flex-col sm:flex-row items-center gap-3 w-full max-w-md mt-2'>
                    <input
                        type="email"
                        placeholder='Enter your email address...'
                        className='w-full sm:flex-1 h-12 bg-[#0c2025]/80 border border-white/15 rounded-xl px-4 text-white text-sm placeholder:text-slate-400 focus:outline-none focus:border-[#56dbfc] transition-all'
                        required
                    />
                    <button 
                        type="submit"
                        className='w-full sm:w-auto h-12 px-6 bg-[#56dbfc] text-slate-950 font-bold text-sm rounded-xl hover:bg-[#7ce2fc] active:scale-95 transition-all shadow-[0_0_15px_rgba(86,219,252,0.3)]'
                    >
                        Subscribe
                    </button>
                </form>
